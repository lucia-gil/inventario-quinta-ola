...
<%
    ...
    // Tag actual (si está editando, tomar el primero de la lista de tags del item)
    String tagActual = "";
                    ...
                    <form action="<%= ctx %>/AdminItemServlet" method="POST" id="itemForm">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nombre" class="form-input" required
                                   placeholder="Ej. Kit de Ayuda Humanitaria, Polera Quinta Ola, Cemento Portland..."
                        ...
                        <div class="form-row">
                            <div>
                                ...
                                <select name="tags" id="tagSelect" class="form-select">
                                    ...
                                    <option value="<%= t %>" <%= t.equals(tagActual) ? "selected" : "" %>>
                                        <%= t %>
                                    </option>
                                    <% } } %>
                                </select>
                            ...
                            <div>
                                ...
                                <input type="number" name="stock" min="0" class="form-input"
                                       ...
                                       value="<%= isEditMode ? item.getCachedQuantity() : "" %>"
                                        <%= isEditMode ? "readonly title='El stock se modifica mediante transacciones'" : "required" %>/>
                                <% if (isEditMode) { %>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // Si el usuario escribe en "tag nuevo", limpiar el select
