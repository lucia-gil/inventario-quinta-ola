...
<head>
    ...
    <title>Cambiar Contraseña | Quinta Ola</title>
...
<div class="panel-form" style="max-width: 420px; width: 100%; margin: 1.5rem;">
    ...
    <div style="text-align:center; margin-bottom: 1.5rem;">
        ...
        <h1 class="page-title" style="font-size: 1.4rem;">Cambia tu contraseña</h1>
        <p class="page-subtitle">Por seguridad, debes actualizar tu contraseña temporal antes de continuar.</p>
    </div>
    ...
    <form action="<%= ctx %>/AuthServlet" method="POST">
        ...
        <button type="submit" class="btn-page-primary btn-icon" style="width:100%; justify-content:center; padding: 0.75rem;">
            <i data-lucide="check"></i> Actualizar contraseña
        </button>
    </form>
